		...
		<RoleGate allowedRole="ADMIN">
			<div className="mt-6 bg-gray-100 p-4 rounded-lg dark:bg-gray-800">
				...
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
					<div>
						<p className="text-gray-500 dark:text-gray-400">Initial Account</p>
						<p className="text-2xl font-bold">{formatCurrency(data.initial)}</p>
					</div>
					<div>
						<p className="text-gray-500 dark:text-gray-400">Total Expenses</p>
						<p className="text-2xl font-bold">{formatCurrency(data.outcome)}</p>
					</div>
					<div>
					...
					<div>
						...
						<p className="text-2xl font-bold">{formatCurrency(data.refund)}</p>
					</div>
					<div>
