...
import { ArrowBigDownIcon, BoxesIcon } from "lucide-react";
...
const CategoryList = ({ data }: { data: CategoryProps }) => {
	return (
		<Collapsible className="border border-primary rounded-md shadow-sm ">
			<CollapsibleTrigger className="flex justify-between items-center w-full gap-2">
				<div className="flex rounded-t-md w-full md:max-w-[400px] items-center  justify-between px-4 py-3 mb-2 bg-gray-100 dark:bg-gray-800 border-b border-r border-primary rounded-br-3xl rounded-tr-none">
